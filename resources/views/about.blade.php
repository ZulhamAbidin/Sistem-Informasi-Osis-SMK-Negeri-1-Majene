...
<div
    class="top-bar-boxed border-b border-white/[0.08] md:mt-0 -mx-3 sm:-mx-8 md:mx-0 px-3 sm:px-8 md:px-6 mb-10 md:mb-8">
...
<div class="content content--top-nav">
   <div  class="max-w-screen-xl px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto  text-gray-900 rounded-lg -lg">
        ...
        <footer id="footer">
            ...
            <div class="mt-20 bg-primary rounded-lg" data-wow-delay=".25s">
